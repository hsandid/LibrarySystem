//Who worked on this part : Ahmad , Farah , Hadi
//Roles : Ahmad-> Function connecting to the MySQL database and extacting data + database init/values
//      : Farah -> Socket programming to connect the server/client     
//      : Hadi -> Utilizing code from the SkillServers file to make the server multithreaded
